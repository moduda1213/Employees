...
<body>
	<%
		...
		Connection conn = DriverManager.getConnection(
				...
				"root",
				"java1004");
		String sql = "select * from salaries order by emp_no desc limit ?,?";
	...
	<div>
		...
		%>
			<a href="./salariesList.jsp?currentPage=1">처음으로</a>
			<a href ="./salariesList.jsp?currentPage=<%=currentPage-1%>">이전</a>
		<%
			}
		%>
			
		<%
			String sql2 = "select count(*) from salaries";
		...
		%>
				<a href ="./salariesList.jsp?currentPage=<%=currentPage+1%>">다음</a>
				<a href="./salariesList.jsp?currentPage=<%=lastPage%>">마지막으로</a>
		<%
			}
		%>
